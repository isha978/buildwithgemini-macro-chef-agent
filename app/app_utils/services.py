...
"""Process-wide ADK session/memory/artifact services shared by every serving surface.
...
def get_memory_service():
    ...
    agent_engine_id = (
        os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID") or "1892543185402462208"
    )
    project_id = (
        os.environ.get("GOOGLE_CLOUD_PROJECT") or "qwiklabs-gcp-02-4b6f07bf9464"
    )
    location = (
